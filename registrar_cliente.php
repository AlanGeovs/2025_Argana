                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row mt-1">
                                            ...
                                            <!-- <div class="form-group col-md-4 m-0">
                                                ...
                                                <input type="date" class="form-control input-control" id="birthday" name="birthday">
                                            </div> -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 m-0">
                                                <label for="descripcion">Nombre comercial</label>
                                                <input type="text" class="form-control input-control input-no-text" id="trading_name" name="trading_name" placeholder="Nombre comercial">
                                            </div>
                                            <div class="form-group col-md-6 m-0">
                                                <label for="descripcion">Nombre legal</label>
                                                <input type="text" class="form-control input-control input-no-text" id="legal_name" name="legal_name" placeholder="Nombre legal de la empresa o persona física">
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <!-- <div class="form-group col-md-12 m-0">
                                                ...
                                                <textarea class="form-control r-0" id="ref" name="ref" rows="5" class="form-control"></textarea>
                                            </div> -->
