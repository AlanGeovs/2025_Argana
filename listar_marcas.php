    ...
    <body class="light sidebar-mini sidebar-collapse">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 mb-3">
                                                    ...
                                                    <div class="form-group">
                                                        <input class="form-control form-control-lg" type="text" placeholder="Buscar marca" id="filtro">
                                                    </div>
                                                    <button type="button" class="btn btn-primary mt-2" onclick="filtrarMarca()"><i class="icon-search3 mr-2"></i>Buscar
                                                    </button>
                                                </div>
                                                <div class="col-md-4 mb-3 mt-5">
                                                    <a href="registrar_marca.php" class="btn btn-primary btn-lg r-20"><i class="icon-plus-circle mr-2"></i>Agregar al inventario</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-hover">
                                            <tbody>
                                                ...
                                                if ($_SESSION["tipoUsuario"] == "admin") {
                                                    $respuesta = Consultas::listarMarcas();
                                                } else {
                                                    $respuesta = Consultas::listarMarcasCapturista($_SESSION["idUser"]);
                                                }
        ...
        <script type="text/javascript">
            function filtrarMarca() {
                ...
                xmlhttp.open("POST", "includes/filtrarMarca.php", true);

                xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");

                xmlhttp.send("marca=" + filtro);
            }
            ...
            function eliminarMarca(id) {
                ...
                swal({
                    ...
                    if (willDelete) {
                        swal("Esta marca ha sido eliminada correctamente!", {
                            icon: "success",
                        })
                        //$("#eliminar"+id).hide();
                        $.ajax({
                            type: "POST",
                            url: "includes/eliminarMarca_db.php",
                            data: {
                                idd: id
                            },
