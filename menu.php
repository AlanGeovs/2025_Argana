...
<aside class="main-sidebar fixed offcanvas b-r sidebar-tabs" data-toggle='offcanvas'>
    <div class="sidebar">
        <div class="d-flex hv-100 align-items-stretch">
            <div class="purple darken-3 text-white">
            ...
            <div class="tab-content flex-grow-1" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <!--Clientes-->
                        <?php
                        if ($_SESSION["tipoUsuario"] == "admin" || $_SESSION["tipoUsuario"] == "supervisor" || $_SESSION["tipoUsuario"] == "asesor") {
                        ?>
                            <li class="treeview"><a href="#">
                                    <i class="icon icon icon-user-circle-o s-24"></i>
                                    Clientes <i class=" icon-angle-left  pull-right"></i>
                                    <!--<span class="badge r-3 badge-primary pull-right">4</span>-->
                                </a>
                                <ul class="treeview-menu">

                                    <li><a href="listar_clientes.php"><i class="icon icon-search-plus"></i>Listar
                                            clientes</a>
                                    </li>

                                    <li><a href="registrar_cliente.php"><i class="icon icon-add"></i>Agregar Cliente
                                        </a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        ?>
                            <li class="treeview"><a href="#">
                                    ...
                                    Productos<i class=" icon-angle-left  pull-right"></i>
                                    <!-- <span class="badge r-3 badge-primary pull-right">4</span> -->
                                </a>
                                <ul class="treeview-menu">
                                    <li><a href="listar_productos.php"><i class="icon icon-search-plus"></i>Listar
                                            productos</a>
                                    </li>
                                    <li><a href="registrar_producto.php"><i class="icon icon-add"></i>Agregar producto </a>
                                    </li>
                                    <!-- <li><a href="actualizar_producto.php"><i class="icon icon-update"></i>Actualizar productos </a>
                                </li> -->
                                </ul>
                            </li>
                        <?php
                        ...
                        ?>
                            <li class="treeview"><a href="#">
                                    ...
                                    <i class="icon icon icon-exchange2 s-24"></i>
                                    Operaciones <i class=" icon-angle-left  pull-right"></i>
                                    <!-- <span class="badge r-3 badge-primary pull-right">4</span> -->
                                </a>
                                <ul class="treeview-menu">
                                    <li><a href="listar_pedidos.php"><i class="icon icon-search-plus"></i>Ver operaciones</a></li>
                                    <?php
                                    if ($_SESSION["tipoUsuario"] == "admin" || $_SESSION["tipoUsuario"] == "supervisor") {
                                        echo '<li><a href="registrar_operacion.php"><i class="icon icon-add"></i>Registrar operación</a></li>';
                                    }
                                    ?>
                                    <!-- <li><a href="listar_pedidos.php"><i class="icon icon-search-plus"></i>Ver operaciones</a>
                                    </li>
                                    <li><a href=" registrar_operacion.php"><i class="icon icon-add"></i>Registrar operación </a>
                                    </li> -->
                                    <!-- <li><a href=" registrar_estados_de_cuenta.php"><i class="icon icon-add"></i>Estados de cuenta</a>
                                </li> -->
                                </ul>
                            </li>
                        <?php } ?>
                        ...
                        ?>
                            ...
                            <li class="treeview"><a href="#"><i class="icon icon-users s-24"></i>Usuarios<i class=" icon-angle-left  pull-right"></i></a>
                                <ul class="treeview-menu">
                        ...
                        <!-- Mi Cuenta  -->
                        <li class="treeview">
                            <a href="perfil.php?u=<?php echo $_SESSION["idUser"]; ?>">
                                <i class="icon icon-account_box s-24"></i> <span>Mi cuenta</span>
                            </a>
                        </li>
        ...
        <div class="navbar navbar-expand d-flex justify-content-between bd-navbar white shadow">
            <div class="relative">
                <div class="d-flex">
                    <div class="d-none d-md-block">
                        <!--<img src="images/logo-htal-min.png" alt=""/>-->
                        <img src="images/logo-tradex-cuadraro.png" width="60px" />

                        <!-- <h1 class="nav-title">Sistema de Clientes y Ventas - Operaciones Tradex</h1> -->
                    </div>
                </div>
            </div>
            <!--Top Menu Start -->
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <?php
                        $cantidadProductos = Carrito::obtenerCantidadProductosCarrito();
                        if ($cantidadProductos > 0) {
                            echo '<a href="#" class="nav-link ml-2" data-toggle="control-sidebar">
                                    <i class="icon-shopping-cart"></i>
                                    <span class="badge badge-success badge-mini rounded-circle">' . $cantidadProductos . '</span>
                                  </a>';
                        }
