                ...
                <div class="animated fadeInUpShort go">
                    <div class="row my-3">
                        <div class="col-md-8 offset-md-2">
                            ...
                            <form id="formRegistroProductos" method="post" enctype="multipart/form-data">
                                <div class="card no-b">
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6 m-0">
                                                        ...
                                                        <input type="text" class="form-control input-control input-no-text" id="product_name" name="product_name" placeholder="Nombre del producto" required>
                                                    </div>
                                                    <div class="form-group col-md-6 m-0">
                                                        <label for="author">Proveedor / Fabricante</label>
                                                        <input type="text" class="form-control input-control input-no-text" id="author" name="author" placeholder="Marca o nombre del proveedor" required>
                                                    </div>
                                                    <div class="form-group col-md-12 m-0">
                                                        <label for="description">Descripción</label>
                                                        <input type="text" class="form-control input-control input-no-text" id="description" name="description" placeholder="Descripción del producto">
                                                    </div>
                                        ...
                                        <div class="form-row mt-1">
                                            <div class="form-group col-md-6 m-0">
                                                <label for="SKU" class="col-form-label s-12">
                                                    <!-- <i class="icon-envelope-o mr-2"></i> -->
                                                    SKU </label>
                                                <input type="text" class="form-control input-control input-no-text" id="SKU " name="SKU " placeholder="Identificador único del producto">
                                            </div>

                                            <div class="form-group col-md-6 m-0">
                                                <label for="price_public" class="col-form-label s-12">
                                                    <!-- <i class="icon-phone mr-2"></i> -->
                                                    Precio Público</label>
                                                <input type="text" class="form-control input-control input-no-text" id="price_public" name="price_public" placeholder="$ 250">
                                            </div>
                                            <div class="form-group col-md-6 m-0">
                                                <label for="price_supplier" class="col-form-label s-12">
                                                    <!-- <i class="icon-mobile-phone mr-2"></i> -->
                                                    Precio del proveedor</label>
                                                <input type="text" class="form-control input-control input-no-text" id="price_supplier" name="price_supplier" placeholder="$ 250">
                                            </div>
                                            <div class="form-group col-md-6 m-0">
                                                <label for="stock" class="col-form-label s-12">
                                                    <!-- <i class="icon-calendar mr-2"></i> -->
                                                    Stock</label>
                                                <input type="text" class="form-control input-control" id="stock" name="stock">
                                            </div>
...
<?php
>>>>>>> 59582b80c4b5a1537ed3541bfcc89c285c121555
}//termina else