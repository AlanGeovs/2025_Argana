                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="vigencia" name="vigencia" class="date-time-picker form-control" data-options='{"timepicker":false, "format":"d-m-Y"}' value="<?php echo $respuesta["VIGENCIA"]; ?>" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="ult_certi_notarial" name="ult_certi_notarial" class="date-time-picker form-control" data-options='{"timepicker":false, "format":"d-m-Y"}'" value=" <?php echo $respuesta["ULTIMA_CERT_NOTARIAL"]; ?>" />
                                                    <span class="input-group-append">
                                                        <span class="input-group-text add-on white">
                                                            <i class="icon-calendar"></i>
                                                        </span>
